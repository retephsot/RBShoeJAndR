...
public class EditAppointmentPageLocators extends PageBase {
	
	public EditAppointmentPageLocators(WebDriver driver) {
		super(driver);
	}
	 ...
	 * XPath Locators
	 */
	public static final String SERVICE_LIST_DROPDOWN_MENU_LIST_BTN_X = "//div[contains(text(),'Edit Appointment')]/parent::*/parent::*//div[contains(@class,'slds-input-has-icon--right serviceLookup')]//button";
